...
CREATE OR REPLACE FUNCTION "public"."get_org_features"("p_org_id" "uuid") RETURNS TABLE("tier_code" "text", "max_branches" integer, "max_benchmark_plots" integer, "global_benchmark_enabled" boolean, "forecast_enabled" boolean)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  select
...
CREATE OR REPLACE FUNCTION "public"."platform_audit_insert"("p_action" "text", "p_entity" "text", "p_entity_id" "text", "p_org_id" "uuid" DEFAULT NULL::"uuid", "p_meta" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'auth'
    AS $$
declare
...
ALTER FUNCTION "public"."platform_audit_insert"("p_action" "text", "p_entity" "text", "p_entity_id" "text", "p_org_id" "uuid", "p_meta" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."platform_close_stale_sessions"() RETURNS integer
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare v int;
...
ALTER FUNCTION "public"."platform_close_stale_sessions"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."platform_get_role_mappings"() RETURNS TABLE("kind" "text", "role_label" "text")
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
...
ALTER FUNCTION "public"."platform_get_role_mappings"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."platform_get_user_daily"("p_user_id" "uuid", "p_days" integer DEFAULT 14) RETURNS TABLE("day" "date", "active_seconds" integer, "sessions" integer, "page_views" integer)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  with d as (
...
ALTER FUNCTION "public"."platform_get_user_daily"("p_user_id" "uuid", "p_days" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."platform_get_user_pageviews"("p_user_id" "uuid", "p_days" integer DEFAULT 7) RETURNS TABLE("day" "date", "path" "text", "views" integer)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  select
...
ALTER FUNCTION "public"."platform_get_user_pageviews"("p_user_id" "uuid", "p_days" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."platform_list_audit"("p_days" integer DEFAULT 30, "p_limit" integer DEFAULT 200) RETURNS TABLE("occurred_at" timestamp with time zone, "actor_email" "text", "action" "text", "entity" "text", "entity_id" "text", "org_id" "uuid", "meta" "jsonb")
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  select
...
ALTER FUNCTION "public"."platform_list_audit"("p_days" integer, "p_limit" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."platform_list_org_role_labels"() RETURNS TABLE("role_label" "text")
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_catalog'
    AS $$
...
ALTER FUNCTION "public"."platform_list_org_role_labels"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."platform_list_user_sessions"("p_user_id" "uuid", "p_limit" integer DEFAULT 50) RETURNS TABLE("org_id" "uuid", "org_name" "text", "started_at" timestamp with time zone, "last_seen_at" timestamp with time zone, "ended_at" timestamp with time zone, "end_reason" "text", "user_agent" "text")
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  select
...
ALTER FUNCTION "public"."platform_list_user_sessions"("p_user_id" "uuid", "p_limit" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."platform_list_users"("p_limit" integer DEFAULT 200) RETURNS TABLE("user_id" "uuid", "email" "text", "created_at" timestamp with time zone, "last_seen_at" timestamp with time zone, "is_online" boolean, "orgs" "jsonb")
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public', 'auth'
    AS $$
  with u as (
...
ALTER FUNCTION "public"."platform_list_users"("p_limit" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."platform_purge_activity"("p_keep_sessions_days" integer DEFAULT 90, "p_keep_daily_days" integer DEFAULT 180, "p_keep_audit_days" integer DEFAULT 365) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."platform_purge_activity"("p_keep_sessions_days" integer, "p_keep_daily_days" integer, "p_keep_audit_days" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."platform_set_member_role_kind"("p_org_id" "uuid", "p_user_id" "uuid", "p_kind" "text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."platform_set_member_role_kind"("p_org_id" "uuid", "p_user_id" "uuid", "p_kind" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."platform_set_role_mapping"("p_kind" "text", "p_role_label" "text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
...
ALTER FUNCTION "public"."platform_set_role_mapping"("p_kind" "text", "p_role_label" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."track_user_page_view"("p_org_id" "uuid", "p_path" "text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."track_user_page_view"("p_org_id" "uuid", "p_path" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."track_user_session_end"("p_session_id" "uuid", "p_reason" "text" DEFAULT 'logout'::"text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."track_user_session_end"("p_session_id" "uuid", "p_reason" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."track_user_session_heartbeat"("p_session_id" "uuid", "p_org_id" "uuid", "p_delta_seconds" integer DEFAULT 60) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."track_user_session_heartbeat"("p_session_id" "uuid", "p_org_id" "uuid", "p_delta_seconds" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."track_user_session_start"("p_org_id" "uuid", "p_user_agent" "text" DEFAULT NULL::"text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."track_user_session_start"("p_org_id" "uuid", "p_user_agent" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."trg_audit_org_members"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
begin
...
ALTER FUNCTION "public"."trg_audit_org_members"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."trg_audit_orgs"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
begin
...
ALTER FUNCTION "public"."trg_audit_orgs"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."trg_enforce_forecast_enabled"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
...
ALTER FUNCTION "public"."trg_enforce_forecast_enabled"() OWNER TO "postgres";
...
CREATE SEQUENCE IF NOT EXISTS "public"."platform_audit_log_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE "public"."platform_audit_log_id_seq" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."platform_role_mappings" (
    ...
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_by" "uuid",
    CONSTRAINT "platform_role_mappings_kind_check" CHECK (("kind" = ANY (ARRAY['admin'::"text", 'member'::"text"])))
);


ALTER TABLE "public"."platform_role_mappings" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."subscription_tiers" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "forecast_enabled" boolean DEFAULT false NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."user_daily_usage" (
    ...
    CONSTRAINT "user_daily_usage_active_seconds_check" CHECK (("active_seconds" >= 0)),
    CONSTRAINT "user_daily_usage_sessions_check" CHECK (("sessions" >= 0))
);
...
CREATE TABLE IF NOT EXISTS "public"."user_page_views_daily" (
    ...
    "last_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "user_page_views_daily_views_check" CHECK (("views" >= 0))
);


ALTER TABLE "public"."user_page_views_daily" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."platform_role_mappings"
    ADD CONSTRAINT "platform_role_mappings_pkey" PRIMARY KEY ("kind");
...
ALTER TABLE ONLY "public"."user_daily_usage"
    ADD CONSTRAINT "user_daily_usage_pkey" PRIMARY KEY ("user_id", "org_id", "day");



ALTER TABLE ONLY "public"."user_page_views_daily"
    ADD CONSTRAINT "user_page_views_daily_pkey" PRIMARY KEY ("user_id", "org_id", "day", "path");
...
CREATE INDEX "platform_audit_log_occurred_idx" ON "public"."platform_audit_log" USING "btree" ("occurred_at" DESC);



CREATE INDEX "platform_audit_log_org_idx" ON "public"."platform_audit_log" USING "btree" ("org_id", "occurred_at" DESC);
...
CREATE INDEX "user_sessions_open_idx" ON "public"."user_sessions" USING "btree" ("user_id") WHERE ("ended_at" IS NULL);



CREATE INDEX "user_sessions_org_last_seen_idx" ON "public"."user_sessions" USING "btree" ("org_id", "last_seen_at" DESC);



CREATE INDEX "user_sessions_user_last_seen_idx" ON "public"."user_sessions" USING "btree" ("user_id", "last_seen_at" DESC);



CREATE OR REPLACE TRIGGER "trg_audit_org_members" AFTER INSERT OR DELETE OR UPDATE ON "public"."org_members" FOR EACH ROW EXECUTE FUNCTION "public"."trg_audit_org_members"();



CREATE OR REPLACE TRIGGER "trg_audit_orgs" AFTER INSERT OR UPDATE ON "public"."orgs" FOR EACH ROW EXECUTE FUNCTION "public"."trg_audit_orgs"();
...
CREATE OR REPLACE TRIGGER "trg_enforce_forecast_enabled" BEFORE INSERT ON "public"."forecast_runs" FOR EACH ROW EXECUTE FUNCTION "public"."trg_enforce_forecast_enabled"();
...
ALTER TABLE ONLY "public"."user_daily_usage"
    ADD CONSTRAINT "user_daily_usage_org_id_fkey" FOREIGN KEY ("org_id") REFERENCES "public"."orgs"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."user_page_views_daily"
    ADD CONSTRAINT "user_page_views_daily_org_id_fkey" FOREIGN KEY ("org_id") REFERENCES "public"."orgs"("id") ON DELETE CASCADE;
...
CREATE POLICY "platform_role_mappings_select" ON "public"."platform_role_mappings" FOR SELECT TO "authenticated" USING ("public"."is_platform_admin"());



CREATE POLICY "platform_role_mappings_write" ON "public"."platform_role_mappings" TO "authenticated" USING ("public"."is_platform_admin"()) WITH CHECK ("public"."is_platform_admin"());
...
CREATE POLICY "user_daily_usage_select_platform" ON "public"."user_daily_usage" FOR SELECT TO "authenticated" USING ("public"."is_platform_admin"());
...
CREATE POLICY "user_page_views_daily_select_platform" ON "public"."user_page_views_daily" FOR SELECT TO "authenticated" USING ("public"."is_platform_admin"());
...
CREATE POLICY "user_sessions_select_platform" ON "public"."user_sessions" FOR SELECT TO "authenticated" USING ("public"."is_platform_admin"());
...
REVOKE ALL ON FUNCTION "public"."get_org_features"("p_org_id" "uuid") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."platform_audit_insert"("p_action" "text", "p_entity" "text", "p_entity_id" "text", "p_org_id" "uuid", "p_meta" "jsonb") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."platform_audit_insert"("p_action" "text", "p_entity" "text", "p_entity_id" "text", "p_org_id" "uuid", "p_meta" "jsonb") TO "service_role";



REVOKE ALL ON FUNCTION "public"."platform_close_stale_sessions"() FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."platform_close_stale_sessions"() TO "service_role";
GRANT ALL ON FUNCTION "public"."platform_close_stale_sessions"() TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."platform_get_role_mappings"() TO "service_role";
GRANT ALL ON FUNCTION "public"."platform_get_role_mappings"() TO "authenticated";



REVOKE ALL ON FUNCTION "public"."platform_get_user_daily"("p_user_id" "uuid", "p_days" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."platform_get_user_daily"("p_user_id" "uuid", "p_days" integer) TO "service_role";
GRANT ALL ON FUNCTION "public"."platform_get_user_daily"("p_user_id" "uuid", "p_days" integer) TO "authenticated";



REVOKE ALL ON FUNCTION "public"."platform_get_user_pageviews"("p_user_id" "uuid", "p_days" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."platform_get_user_pageviews"("p_user_id" "uuid", "p_days" integer) TO "service_role";
GRANT ALL ON FUNCTION "public"."platform_get_user_pageviews"("p_user_id" "uuid", "p_days" integer) TO "authenticated";



REVOKE ALL ON FUNCTION "public"."platform_list_audit"("p_days" integer, "p_limit" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."platform_list_audit"("p_days" integer, "p_limit" integer) TO "service_role";
GRANT ALL ON FUNCTION "public"."platform_list_audit"("p_days" integer, "p_limit" integer) TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."platform_list_org_role_labels"() TO "service_role";
GRANT ALL ON FUNCTION "public"."platform_list_org_role_labels"() TO "authenticated";
...
REVOKE ALL ON FUNCTION "public"."platform_list_user_sessions"("p_user_id" "uuid", "p_limit" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."platform_list_user_sessions"("p_user_id" "uuid", "p_limit" integer) TO "service_role";
GRANT ALL ON FUNCTION "public"."platform_list_user_sessions"("p_user_id" "uuid", "p_limit" integer) TO "authenticated";



REVOKE ALL ON FUNCTION "public"."platform_list_users"("p_limit" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."platform_list_users"("p_limit" integer) TO "service_role";
GRANT ALL ON FUNCTION "public"."platform_list_users"("p_limit" integer) TO "authenticated";



REVOKE ALL ON FUNCTION "public"."platform_purge_activity"("p_keep_sessions_days" integer, "p_keep_daily_days" integer, "p_keep_audit_days" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."platform_purge_activity"("p_keep_sessions_days" integer, "p_keep_daily_days" integer, "p_keep_audit_days" integer) TO "service_role";
GRANT ALL ON FUNCTION "public"."platform_purge_activity"("p_keep_sessions_days" integer, "p_keep_daily_days" integer, "p_keep_audit_days" integer) TO "authenticated";
...
REVOKE ALL ON FUNCTION "public"."platform_set_member_role_kind"("p_org_id" "uuid", "p_user_id" "uuid", "p_kind" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."platform_set_member_role_kind"("p_org_id" "uuid", "p_user_id" "uuid", "p_kind" "text") TO "service_role";
GRANT ALL ON FUNCTION "public"."platform_set_member_role_kind"("p_org_id" "uuid", "p_user_id" "uuid", "p_kind" "text") TO "authenticated";
...
REVOKE ALL ON FUNCTION "public"."platform_set_role_mapping"("p_kind" "text", "p_role_label" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."platform_set_role_mapping"("p_kind" "text", "p_role_label" "text") TO "service_role";
GRANT ALL ON FUNCTION "public"."platform_set_role_mapping"("p_kind" "text", "p_role_label" "text") TO "authenticated";
...
REVOKE ALL ON FUNCTION "public"."track_user_page_view"("p_org_id" "uuid", "p_path" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."track_user_page_view"("p_org_id" "uuid", "p_path" "text") TO "service_role";
GRANT ALL ON FUNCTION "public"."track_user_page_view"("p_org_id" "uuid", "p_path" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."track_user_session_end"("p_session_id" "uuid", "p_reason" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."track_user_session_end"("p_session_id" "uuid", "p_reason" "text") TO "service_role";
GRANT ALL ON FUNCTION "public"."track_user_session_end"("p_session_id" "uuid", "p_reason" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."track_user_session_heartbeat"("p_session_id" "uuid", "p_org_id" "uuid", "p_delta_seconds" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."track_user_session_heartbeat"("p_session_id" "uuid", "p_org_id" "uuid", "p_delta_seconds" integer) TO "service_role";
GRANT ALL ON FUNCTION "public"."track_user_session_heartbeat"("p_session_id" "uuid", "p_org_id" "uuid", "p_delta_seconds" integer) TO "authenticated";



REVOKE ALL ON FUNCTION "public"."track_user_session_start"("p_org_id" "uuid", "p_user_agent" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."track_user_session_start"("p_org_id" "uuid", "p_user_agent" "text") TO "service_role";
GRANT ALL ON FUNCTION "public"."track_user_session_start"("p_org_id" "uuid", "p_user_agent" "text") TO "authenticated";



GRANT ALL ON FUNCTION "public"."trg_audit_org_members"() TO "service_role";



GRANT ALL ON FUNCTION "public"."trg_audit_orgs"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."trg_enforce_forecast_enabled"() TO "service_role";
...
GRANT SELECT,USAGE ON SEQUENCE "public"."platform_audit_log_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."platform_audit_log_id_seq" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."platform_role_mappings" TO "authenticated";
GRANT ALL ON TABLE "public"."platform_role_mappings" TO "service_role";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."user_daily_usage" TO "authenticated";
GRANT ALL ON TABLE "public"."user_daily_usage" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."user_page_views_daily" TO "authenticated";
GRANT ALL ON TABLE "public"."user_page_views_daily" TO "service_role";
